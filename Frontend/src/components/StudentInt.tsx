    ...
    <div className='mt-16 w-full mb-8' style={{ height: '550px' }}>
      ...
      <form>
        <textarea
          ...
          className='textarea textarea-bordered w-full h-24 text-gray-400 focus:text-gray-800 placeholder-gray-400'
      ...
      <div className='mt-16'>
        ...
        <form>
          <textarea
          className='textarea textarea-bordered w-full h-10 text-gray-400 focus:text-gray-800 placeholder-gray-400'
      ...
      <div className='mt-16'>
        ...
        <form>
          <textarea
          className='textarea textarea-bordered w-full h-32 text-gray-400 focus:text-gray-800 placeholder-gray-400'
          placeholder='Please write the department you are aiming for...'
          ></textarea>
        </form>
      </div>
